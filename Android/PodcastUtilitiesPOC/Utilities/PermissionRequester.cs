...
namespace PodcastUtilitiesPOC.Utilities
{
    class PermissionRequester
    {
        ...
        public static void RequestReadStoragePermission(Activity activity, Android.Views.View view)
        {
        ...
        public static void RequestWriteStoragePermission(Activity activity, Android.Views.View view, int code)
        {
            RequestPermission(activity, view, Resource.String.write_external_permissions_rationale, WRITE_PERMISSIONS_TO_REQUEST, code);
        }

        private static void RequestPermission(Activity activity, Android.Views.View view, int rationaleId, string permission, int code)
        {
